...
from reidlib.utils.loss import triplet_hard_loss, weighted_triplet_hard_loss, weight_cross_entropy, triplet_batch_all_loss
...
def prepare(args):
    ...
    losses['triplet_hard_loss'] = [triplet_hard_loss(margin=Config.triplet_margin),
                                   triplet_batch_all_loss(margin=Config.branch_margin),
                                   triplet_batch_all_loss(margin=Config.branch_margin),
                                   triplet_batch_all_loss(margin=Config.branch_margin),
                                   triplet_batch_all_loss(margin=Config.branch_margin)]
