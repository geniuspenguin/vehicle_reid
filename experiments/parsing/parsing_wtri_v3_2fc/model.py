...
class parsing_branch(nn.Module):
    def __init__(self, nr_class, in_planes, midnum, midnum2):
        super().__init__()
        self.nr_class = nr_class
        self.in_planes = in_planes
        ...
        self.relu = nn.ReLU()
        self.fc_mid2 = nn.Linear(midnum, midnum2)
        self.bn_mid2 = nn.BatchNorm1d(midnum2)
        ...
        self.fc_mid2.apply(weights_init_kaiming)
        self.bn_mid2.apply(weights_init_kaiming)
        self.fc_cls.apply(weights_init_classifier)
        self.bn.apply(weights_init_kaiming)
    ...
    def forward(self, x, mask):
        ...
        feats = self.fc_mid2(feats)
        feats = self.bn_mid2(feats)
