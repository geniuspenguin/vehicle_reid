...
from reidlib.utils.loss import triplet_hard_loss, weighted_triplet_batch_all_loss, weight_cross_entropy, weighted_triplet_batch_all_loss_v4
...
def prepare(args):
    ...
    losses['triplet_hard_loss'] = [triplet_hard_loss(margin=Config.triplet_margin),
                                   weighted_triplet_batch_all_loss_v4(
                                       margin=Config.branch_margin, soft_margin=Config.soft_marigin, relu_on_wtri=True),
                                   weighted_triplet_batch_all_loss_v4(
                                       margin=Config.branch_margin, soft_margin=Config.soft_marigin, relu_on_wtri=True),
                                   weighted_triplet_batch_all_loss_v4(
                                       margin=Config.branch_margin, soft_margin=Config.soft_marigin, relu_on_wtri=True),
                                   weighted_triplet_batch_all_loss_v4(margin=Config.branch_margin, soft_margin=Config.soft_marigin, relu_on_wtri=True)]
