...
__all__ = ['ResNet_IBN', 'resnet18_ibn_a', 'resnet34_ibn_a', 'resnet50_ibn_a']
...
model_path = {
    ...
    'resnet50_ibn_a': '/home/peng/Documents/FINAL/pretrain/resnet50_ibn_a.pth',
}
...
def resnet34_ibn_a(pretrained=False, **kwargs):
    ...
    model = ResNet_IBN(block=BasicBlock_IBN,
                       ...
                       **kwargs)
    if pretrained:
        model.load_state_dict(torch.load(model_path['resnet34_ibn_a']))
    return model
...
if __name__ == '__main__':
    net = resnet50_ibn_a(pretrained=True, num_classes=10)
    for p in net.parameters():
        print(p)
    dic = torch.load(model_path['resnet50_ibn_a'])
    for k in dic.keys():
        print(k)
